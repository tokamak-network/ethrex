...
| 커맨드 | 소스 | 타겟 | 상태 |
|--------|------|------|------|
| `g2r` (to-rocksdb) | Geth Pebble | ethrex RocksDB | 블록 + State + 검증 |
| `g2l` (to-lmdb) | Geth Pebble | py-ethclient LMDB | 블록 + State + 검증 |
...
- 사용법: geth-db-migrate g2r ... --verify-deep
```
...
```
geth-db-migrate g2r [OPTIONS] --source <PATH> --target <PATH> --genesis <PATH>
```
...
```
geth-db-migrate g2l [OPTIONS] --source <PATH> --target <PATH>
```
